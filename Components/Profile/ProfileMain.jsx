    ...
    <div class="col-xl-9 col-lg-9 col-md-8">
      <div class="row user-dashboard">
        <div class="col-xl-12 col-lg-12 col-md-12">
          <div class="user-top rounded-xl bg-black shadow-xl">
            ...
            <div class="userboard-btn">
              <a
                class="user-btn coin-btn rounded-lg"
                onClick={() => donateFund()}
              >
                Donate 1 MATIC
              </a>
      ...
      <div class="row dashboard-content">
        {details.map((detail, i) => (
          <div key={i + 1} class="col-xl-4 col-lg-4 col-md-6">
            <div class="single-dash-head rounded-xl bg-black shadow-xl">
      ...
      {open == "Dashbord" ? (
        <Table title="     " tableData={getAllERC20TokenListed} />
      ) : open == "Your Token" ? (
